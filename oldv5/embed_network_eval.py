...
class TextClassifierEvaluate(MRJob):
    ...
    def __init__(self, *args, **kwargs):
        ...
        from util_old import get_vocab, EMBED_DIM, SEQ_LENGTH, HIDDEN_SIZE, OUTPUT_SIZE, MAPPER_SPLIT, FC1_LR, FC2_LR, EMBED_LR
        vocab = get_vocab()
    ...
    def reducer_final(self):
        from util_old import get_abs_output_path
