from embed_network_v2_lrelu import TextClassifierTrainer
from embed_network_v2_lrelu import load_weight as train_load_weight
from embed_network_eval_lrelu import TextClassifierEvaluate
from embed_network_eval_lrelu import load_weight as test_load_weight
import logging
import os
import time
